...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		glassWallpaperRoute := apiRouter.Group("/glass_wallpaper")
		glassWallpaperRoute.GET("/list", controller.ListGlassWallpapers)
		glassWallpaperRoute.POST("/upload", middleware.AdminAuth(), controller.UploadGlassWallpaper)
		glassWallpaperRoute.DELETE("/delete", middleware.AdminAuth(), controller.DeleteGlassWallpaper)
